...
export default function History() {
  ...
  const chartData = monthlyData.map((data) => ({
    ...
    ...Object.entries(data.skills).reduce((acc, [skill, progress]) => {
      acc[skill] = Math.round(progress as number);
      return acc;
    }, {} as Record<string, number>),
  }));

  const skillNames = monthlyData.length > 0
    ? Object.keys(monthlyData[monthlyData.length - 1].skills)
    : [];
          ...
          {monthlyData.length === 0 ? (
            ...
            <>
              ...
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-md rounded-lg border border-white/20 p-8 mb-8"
              >
                    ...
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <p className="text-sm text-purple-300">Level {data.level}</p>
                        </div>
                        <div className="text-right">
                          <p className="text-2xl font-bold text-purple-400">{data.totalXpGained}</p>
                      ...
                      <div className="mb-4 pb-4 border-b border-white/10">
                        <p className="text-sm text-gray-300">
                          {data.totalActivities} activities logged
                        </p>
                      </div>
